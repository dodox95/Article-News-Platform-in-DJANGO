...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'static/.next/server/pages'),
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 52428800  # in bytes
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static/.next/static'),
    os.path.join(BASE_DIR, 'templates'),
